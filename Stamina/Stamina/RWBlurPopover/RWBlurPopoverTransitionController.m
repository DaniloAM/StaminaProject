...
- (void)animatePresentation:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    blurView.alpha = 0;
    Cadastro *cadastro = [Cadastro alloc];
    blurView.userInteractionEnabled = ![cadastro should];
    //[self performSelector:@selector(_RWBlurPopoverDismiss) withObject:nil afterDelay:2];
